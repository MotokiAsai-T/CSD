...
def calc_Multiplied_sum(r_size, s_size, P_slice, d_mu_sd_before, s_idx, d_idx):
    ...
    for n in range(1, n_size):
        ...
        for s_idx in range(s_size):
            for d_idx in range(d_size):
                ...
                Multiplied_sum = calc_Multiplied_sum(r_size, s_size, P_slice, d_mu_sd_before, s_idx, d_idx)
